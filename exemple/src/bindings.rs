...
pub const _LIBCPP_VERSION: u32 = 15007;
...
extern "C" {
    #[link_name = "\u{1}__Z12return_floatv"]
    pub fn return_float() -> f32;
}
extern "C" {
    #[link_name = "\u{1}__Z21return_const_char_ptrv"]
    pub fn return_const_char_ptr() -> *const ::std::os::raw::c_char;
}
extern "C" {
    #[link_name = "\u{1}__Z21return_int_by_pointerv"]
    pub fn return_int_by_pointer() -> *mut ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}__Z23return_int_by_referencev"]
    pub fn return_int_by_reference() -> *mut ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}__Z16add_int_by_valueii"]
    pub fn add_int_by_value(
        a: ::std::os::raw::c_int,
        b: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}__Z18add_int_by_pointerPiS_"]
    pub fn add_int_by_pointer(
        a: *mut ::std::os::raw::c_int,
        b: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}__Z20add_int_by_referenceRiS_"]
    pub fn add_int_by_reference(
        a: *mut ::std::os::raw::c_int,
        b: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
